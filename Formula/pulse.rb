...
class Pulse < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://repo.splunkdev.net/artifactory/generic/observability/ao/pulse/v#{version}/pulse-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://repo.splunkdev.net/artifactory/generic/observability/ao/pulse/v#{version}/pulse-linux-amd64"
